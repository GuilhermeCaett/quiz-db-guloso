  ...
  app.innerHTML = `
    <main class="sales-page">
      ...
      <section class="sales-section"><div class="wide"><div class="section-head"><p class="eyebrow" style="justify-content:center">${icon("gift")} Seu pacote completo</p><h2>Tudo o que você recebe hoje</h2></div><div class="deliverables">
        <div class="deliverable"><div>${icon("check")}<span><strong>Diabético Guloso</strong>Mais de 50 receitas organizadas</span></div></div>
        <div class="deliverable"><div>${icon("check")}<span><strong>Bônus 1</strong>Lista de compras para diabéticos</span></div></div>
